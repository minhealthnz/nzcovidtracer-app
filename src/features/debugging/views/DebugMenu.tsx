    ...
    () => [
      ...
      },
      {
        ...
        commands: [
          ...
          enfSimulateExposure(exposure, 6),
          enfSimulateExposure(exposure, 7),
          enfSimulateExposure(exposure, 8),
          enfSimulateExposure(exposure, 9),
          enfSimulateExposure(exposure, 10),
          enfSimulateExposure(exposure, 11),
          enfSimulateExposure(exposure, 12),
          enfSimulateExposure(exposure, 13),
          enfSimulateExposure(exposure, 14),
          enfSimulateExposure(exposure, 15),
